...
class TextConverter:
    ...
    def get_all_pseudorandom_lists(self, file_address_bird_name, file_address_bird_hexes, file_address_bg_name, file_address_bg_hexes):
        ...
        random_list =  random.sample(number_list, 14)
        ...
        random_list =  random.sample(number_list, 8)
        ...
        with open("E:\\ARCHIVE\\FREELANCE\\NFT\\LogFiles\\python_lvl4_log.txt", 'w') as f:
            for line in lines:
                f.write(line)
...
hex_file = "E:\\ARCHIVE\\FREELANCE\\NFT\\Projects\\Pigeon\\LV_2\\LV_2_production\\HEX_CODES\\Hardcore_Hex_Code.txt"
name_file = "E:\\ARCHIVE\\FREELANCE\\NFT\\Projects\\Pigeon\\LV_2\\LV_2_production\\HEX_CODES\\Hardcore_Name.txt"
bg_hex_file = "E:\\ARCHIVE\\FREELANCE\\NFT\\Projects\\Pigeon\\LV_2\\LV_2_production\\HEX_CODES_BG\\Hardcore_Hex_Code_Selected.txt"
bg_name_file = "E:\\ARCHIVE\\FREELANCE\\NFT\\Projects\\Pigeon\\LV_2\\LV_2_production\\HEX_CODES_BG\\Hardcore_Name_Selected.txt"
